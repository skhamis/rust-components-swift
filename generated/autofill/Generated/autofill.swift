...
private extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_autofill_6681_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_autofill_6681_rustbuffer_free(self, $0) }
    }
}
...
public func encryptString(key: String, cleartext: String) throws -> String {
    let _retval = try
        ...
        rustCallWithError(AutofillError.self) {
            autofill_6681_encrypt_string(key.lower(), cleartext.lower(), $0)
        }
    return try String.lift(_retval)
}
...
public func decryptString(key: String, ciphertext: String) throws -> String {
    let _retval = try
        ...
        rustCallWithError(AutofillError.self) {
            autofill_6681_decrypt_string(key.lower(), ciphertext.lower(), $0)
        }
    return try String.lift(_retval)
}
...
public class Store: StoreProtocol {
    ...
    public convenience init(dbpath: String) throws {
        self.init(unsafeFromRawPointer: try
            ...
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_new(dbpath.lower(), $0)
            })
    }

    deinit {
        try! rustCall { ffi_autofill_6681_Store_object_free(pointer, $0) }
    }

    public func addCreditCard(cc: UpdatableCreditCardFields) throws -> CreditCard {
        let _retval = try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_add_credit_card(self.pointer, cc.lower(), $0)
            }
    ...
    public func getCreditCard(guid: String) throws -> CreditCard {
        let _retval = try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_get_credit_card(self.pointer, guid.lower(), $0)
            }
        return try CreditCard.lift(_retval)
    }
    ...
    public func getAllCreditCards() throws -> [CreditCard] {
        let _retval = try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_get_all_credit_cards(self.pointer, $0)
            }
    ...
    public func updateCreditCard(guid: String, cc: UpdatableCreditCardFields) throws {
        try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_update_credit_card(self.pointer, guid.lower(), cc.lower(), $0)
            }
    }
    ...
    public func deleteCreditCard(guid: String) throws -> Bool {
        let _retval = try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_delete_credit_card(self.pointer, guid.lower(), $0)
            }
    ...
    public func touchCreditCard(guid: String) throws {
        try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_touch_credit_card(self.pointer, guid.lower(), $0)
            }
    }
    ...
    public func addAddress(a: UpdatableAddressFields) throws -> Address {
        let _retval = try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_add_address(self.pointer, a.lower(), $0)
            }
    ...
    public func getAddress(guid: String) throws -> Address {
        let _retval = try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_get_address(self.pointer, guid.lower(), $0)
            }
        return try Address.lift(_retval)
    }
    ...
    public func getAllAddresses() throws -> [Address] {
        let _retval = try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_get_all_addresses(self.pointer, $0)
            }
    ...
    public func updateAddress(guid: String, a: UpdatableAddressFields) throws {
        try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_update_address(self.pointer, guid.lower(), a.lower(), $0)
            }
    }
    ...
    public func deleteAddress(guid: String) throws -> Bool {
        let _retval = try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_delete_address(self.pointer, guid.lower(), $0)
            }
        return try Bool.lift(_retval)
    }
    ...
    public func touchAddress(guid: String) throws {
        try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_touch_address(self.pointer, guid.lower(), $0)
            }
    }
    ...
    public func scrubEncryptedData() throws {
        try
            rustCallWithError(AutofillError.self) {
                autofill_6681_Store_scrub_encrypted_data(self.pointer, $0)
            }
    }
    ...
    public func registerWithSyncManager() {
        try!
            rustCall {
                autofill_6681_Store_register_with_sync_manager(self.pointer, $0)
            }
    }
}
...
private extension CreditCard {
    ...
    func write(into buf: Writer) {
        ...
        FfiConverterOptionInt64.write(timeLastUsed, into: buf)
...
// Helper code for Store class is found in ObjectTemplate.swift
// Helper code for Address record is found in RecordTemplate.swift
// Helper code for CreditCard record is found in RecordTemplate.swift
// Helper code for UpdatableAddressFields record is found in RecordTemplate.swift
// Helper code for UpdatableCreditCardFields record is found in RecordTemplate.swift
// Helper code for AutofillError error is found in ErrorTemplate.swift
...
private enum FfiConverterSequenceRecordAddress: FfiConverterUsingByteBuffer {
...
private enum FfiConverterSequenceRecordCreditCard: FfiConverterUsingByteBuffer {
